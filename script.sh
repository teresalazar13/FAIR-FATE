...
#python3 main.py --dataset $DATASET --fl FedMom --beta 0.9 --n_runs $N_RUNS --n_rounds $N_ROUNDS
...
#python3 main.py --dataset $DATASET --fl FairFate --beta 0.99 --rho 0.047 --l0 0.1 --MAX 1 --metrics TPR --n_runs $N_RUNS --n_rounds $N_ROUNDS
...
#python3 main.py --dataset $DATASET --fl FairFed --alpha $ALPHA --beta 1 --metrics $METRICS --n_runs $N_RUNS --n_rounds $N_ROUNDS
#python3 main.py --dataset $DATASET --fl FedVal --alpha $ALPHA --metrics $METRICS --n_runs $N_RUNS --n_rounds $N_ROUNDS
#python3 main.py --dataset $DATASET --fl FairFate --alpha $ALPHA --beta 0.8 --rho 0.045 --l0 0.1 --MAX 1 --metrics TPR --n_runs $N_RUNS --n_rounds $N_ROUNDS
...
#python3 main.py --dataset $DATASET --fl FairFed --alpha $ALPHA --beta 1 --metrics $METRICS --n_runs $N_RUNS --n_rounds $N_ROUNDS
#python3 main.py --dataset $DATASET --fl FedVal --alpha $ALPHA --metrics $METRICS --n_runs $N_RUNS --n_rounds $N_ROUNDS
python3 main.py --dataset $DATASET --fl FairFate --alpha $ALPHA --beta 0.7 --rho 0.047 --l0 0.1 --MAX 1 --metrics TPR --n_runs $N_RUNS --n_rounds $N_ROUNDS
